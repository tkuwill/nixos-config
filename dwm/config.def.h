...
static const char *fonts[]          = { "SauceCodeProNerdFont:size=12" };
static const char dmenufont[]       = "SauceCodeProNerdFont:size=15" ;
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, "#f7fa3e",  "#f7fa3e"  },
	[SchemeStatus]  = { col_gray3, col_gray1,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { "#000000", "#ffd700",  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
	[SchemeTagsNorm]  = { col_gray3, col_gray1,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
	[SchemeInfoSel]  = { "#000000", "#ffd700",  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
